...
#if defined(_AKA_COMPILE_WITH_SDL_DEVICE_)
#include <SDL/SDL_endian.h>
#define bswap_16(X) SDL_Swap16(X)
#define bswap_32(X) SDL_Swap32(X)
#elif defined(_AKA_WINDOWS_API_) && defined(_MSC_VER) && (_MSC_VER > 1298)
#include <stdlib.h>
...
namespace aka
{
	namespace os
	{
		...
		{
#if !defined(_WIN32_WCE) && !defined (_AKA_XBOX_PLATFORM_)
