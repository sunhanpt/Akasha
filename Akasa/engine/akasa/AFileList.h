...
namespace aka
{
	namespace io
	{
		...
		public:
			...
			virtual u32 addItem(const io::path& fullPath, u32 offset, u32 size, bool isDirectory, u32 id = 0) _AKA_OVERRIDE_;

			//! Sorts the file list. You should call this after adding any items to the file list
			virtual void sort() _AKA_OVERRIDE_;

			//! Returns the amount of files in the filelist.
			virtual u32 getFileCount() const _AKA_OVERRIDE_;

			//! Gets the name of a file in the list, based on an index.
			virtual const io::path& getFileName(u32 index) const _AKA_OVERRIDE_;

			//! Gets the full name of a file in the list, path included, based on an index.
			virtual const io::path& getFullFileName(u32 index) const _AKA_OVERRIDE_;

			//! Returns the ID of a file in the file list, based on an index.
			virtual u32 getID(u32 index) const _AKA_OVERRIDE_;

			//! Returns true if the file is a directory
			virtual bool isDirectory(u32 index) const _AKA_OVERRIDE_;

			//! Returns the size of a file
			virtual u32 getFileSize(u32 index) const _AKA_OVERRIDE_;

			//! Returns the offset of a file
			virtual u32 getFileOffset(u32 index) const _AKA_OVERRIDE_;

			//! Searches for a file or folder within the list, returns the index
			virtual s32 findFile(const io::path& filename, bool isFolder) const _AKA_OVERRIDE_;

			//! Returns the base path of the file list
			virtual const io::path& getPath() const _AKA_OVERRIDE_;
