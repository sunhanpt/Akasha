...
#ifndef __AKA_TYPES_H_INCLUDED__
#define __AKA_TYPES_H_INCLUDED__

#include "AkaCompileConfig.h"
...
#define swprintf_aka swprintf_s
#define snprintf_aka sprintf_s
#elif !defined(__CYGWIN__)
#define swprintf_aka _snwprintf
#define snprintf_aka _snprintf
#endif
...
namespace aka
{
	...
	strings
	*/
#if defined(_AKA_WCHAR_FILESYSTEM)
...
#if defined(_DEBUG)
#if defined(_AKA_WINDOWS_API_) && defined(_MSC_VER) && !defined (_WIN32_WCE)
#if defined(WIN64) || defined(_WIN64) // using portable common solution for x64 configuration
#include <crtdbg.h>
#define _AKA_DEBUG_BREAK_IF( _CONDITION_ ) if (_CONDITION_) {_CrtDbgBreak();}
#else
#define _AKA_DEBUG_BREAK_IF( _CONDITION_ ) if (_CONDITION_) {_asm int 3}
#endif
#else
#include "assert.h"
#define _AKA_DEBUG_BREAK_IF( _CONDITION_ ) assert( !(_CONDITION_) );
#endif
#else
#define _AKA_DEBUG_BREAK_IF( _CONDITION_ )
#endif
...
#if defined(_AKA_WINDOWS_API_) && defined(_MSC_VER) && (_MSC_VER >= 1400)
...
#endif // __AKA_TYPES_H_INCLUDED__
