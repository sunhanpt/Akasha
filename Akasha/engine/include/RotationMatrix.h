...
public:
	...
	static AKADLL_API FMatrix MakeFromXY(FVector const& XAxis, FVector const& YAxis);
	...
	static AKADLL_API FMatrix MakeFromXZ(FVector const& XAxis, FVector const& ZAxis);
	...
	static AKADLL_API FMatrix MakeFromYX(FVector const& YAxis, FVector const& XAxis);
	...
	static AKADLL_API FMatrix MakeFromYZ(FVector const& YAxis, FVector const& ZAxis);
	...
	static AKADLL_API FMatrix MakeFromZX(FVector const& ZAxis, FVector const& XAxis);
	...
	static AKADLL_API FMatrix MakeFromZY(FVector const& ZAxis, FVector const& YAxis);
};
