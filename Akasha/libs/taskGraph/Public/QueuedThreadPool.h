...
public:
	 ...
	 */
	virtual bool Create( unsigned int InNumQueuedThreads, unsigned int StackSize = (32 * 1024), EThreadPriority ThreadPriority=TPri_Normal ) = 0;
...
public:
	 ...
	 */
	static unsigned int OverrideStackSize;
};
